...
try:
    ...
    try:
        with open("/Users/danielstevens/Desktop/github-projects/tools-automation/agents/strategy_tracker.py", 'r') as f:
            compile(f.read(), "/Users/danielstevens/Desktop/github-projects/tools-automation/agents/strategy_tracker.py", 'exec')
        print(f"File agents/strategy_tracker.py is syntactically valid but import failed")
...
class TestAgentsStrategyTracker:
    ...
    def test_file_exists(self):
        ...
        assert os.path.exists("/Users/danielstevens/Desktop/github-projects/tools-automation/agents/strategy_tracker.py")
    ...
    # TODO: Add specific tests for functions in agents/strategy_tracker.py
