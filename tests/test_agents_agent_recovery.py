...
try:
    ...
    try:
        with open("/Users/danielstevens/Desktop/github-projects/tools-automation/agents/agent_recovery.py", 'r') as f:
            compile(f.read(), "/Users/danielstevens/Desktop/github-projects/tools-automation/agents/agent_recovery.py", 'exec')
...
class TestAgentsAgentRecovery:
    ...
    def test_file_exists(self):
        ...
        assert os.path.exists("/Users/danielstevens/Desktop/github-projects/tools-automation/agents/agent_recovery.py")
