...
AGENT_NAME="test_agents_ai_docs_agent.sh"
...
#!/bin/bash
# Comprehensive test suite for ai_docs_agent.sh

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
AGENT_SCRIPT="${SCRIPT_DIR}/../agents/ai_docs_agent.sh"
...
test_script_executable() {
    assert_file_executable "$AGENT_SCRIPT" "ai_docs_agent.sh should be executable"
}
...
# Test 9: Should have run_ai_documentation function
test_run_ai_documentation_function() {
    assert_pattern_in_file "run_ai_documentation\(\)" "$AGENT_SCRIPT" "Should have run_ai_documentation function"
}
...
# Run all tests
run_tests() {
    echo "Running comprehensive tests for ai_docs_agent.sh..."
    echo "================================================================="
