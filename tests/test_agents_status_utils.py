...
try:
    ...
    try:
        with open("/Users/danielstevens/Desktop/github-projects/tools-automation/agents/status_utils.py", 'r') as f:
            compile(f.read(), "/Users/danielstevens/Desktop/github-projects/tools-automation/agents/status_utils.py", 'exec')
...
class TestAgentsStatusUtils:
    ...
    def test_file_exists(self):
        ...
        assert os.path.exists("/Users/danielstevens/Desktop/github-projects/tools-automation/agents/status_utils.py")
    ...
    # TODO: Add specific tests for functions in agents/status_utils.py
