...
try:
    ...
    try:
        with open("/Users/danielstevens/Desktop/github-projects/tools-automation/agents/max_processor.py", 'r') as f:
            compile(f.read(), "/Users/danielstevens/Desktop/github-projects/tools-automation/agents/max_processor.py", 'exec')
...
class TestAgentsMaxProcessor:
    ...
    def test_file_exists(self):
        ...
        assert os.path.exists("/Users/danielstevens/Desktop/github-projects/tools-automation/agents/max_processor.py")
    ...
    # TODO: Add specific tests for functions in agents/max_processor.py
