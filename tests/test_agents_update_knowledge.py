...
try:
    ...
    try:
        with open("/Users/danielstevens/Desktop/github-projects/tools-automation/agents/update_knowledge.py", 'r') as f:
            compile(f.read(), "/Users/danielstevens/Desktop/github-projects/tools-automation/agents/update_knowledge.py", 'exec')
        print(f"File agents/update_knowledge.py is syntactically valid but import failed")
...
class TestAgentsUpdateKnowledge:
    ...
    def test_file_exists(self):
        ...
        assert os.path.exists("/Users/danielstevens/Desktop/github-projects/tools-automation/agents/update_knowledge.py")
    ...
    # TODO: Add specific tests for functions in agents/update_knowledge.py
