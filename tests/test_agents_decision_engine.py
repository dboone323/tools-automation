...
try:
    ...
    try:
        with open("/Users/danielstevens/Desktop/github-projects/tools-automation/agents/decision_engine.py", 'r') as f:
            compile(f.read(), "/Users/danielstevens/Desktop/github-projects/tools-automation/agents/decision_engine.py", 'exec')
        print(f"File agents/decision_engine.py is syntactically valid but import failed")
...
class TestAgentsDecisionEngine:
    ...
    def test_file_exists(self):
        ...
        assert os.path.exists("/Users/danielstevens/Desktop/github-projects/tools-automation/agents/decision_engine.py")
    ...
    # TODO: Add specific tests for functions in agents/decision_engine.py
