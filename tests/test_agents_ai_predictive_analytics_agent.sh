...
AGENT_NAME="test_agents_ai_predictive_analytics_agent.sh"
...
#!/bin/bash
# Comprehensive test suite for ai_predictive_analytics_agent.sh

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
AGENT_SCRIPT="${SCRIPT_DIR}/../agents/ai_predictive_analytics_agent.sh"
...
test_script_executable() {
    assert_file_executable "$AGENT_SCRIPT" "ai_predictive_analytics_agent.sh should be executable"
}
...
# Test 9: Should have run_predictive_analytics function
test_run_predictive_analytics_function() {
    assert_pattern_in_file "run_predictive_analytics\(\)" "$AGENT_SCRIPT" "Should have run_predictive_analytics function"
}
...
# Run all tests
run_tests() {
    echo "Running comprehensive tests for ai_predictive_analytics_agent.sh..."
    echo "================================================================="
