...
# Test file for agent_deployment.sh
# This file contains comprehensive tests for the deployment agent functionality
...
test_script_has_task_types() {
    grep -q "deployment\|release\|publish" "${AGENT_SCRIPT}"
}
...
# Run all tests
echo "Starting tests for agent_deployment.sh"
echo "====================================="
...
echo ""
echo "==================================="
echo "Test Summary for agent_deployment.sh:"
