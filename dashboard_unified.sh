...
show_workflow_summary() {
  ...
  echo "  🔄 Projects with GitHub workflows: ${projects_with_workflows}"
  echo "  🤖 Projects with automation: ${projects_with_automation}"
  echo "  🔨 Projects building successfully: ${projects_building}"
  echo "  🔍 Projects with clean lint: ${projects_clean_lint}"
  echo ""
