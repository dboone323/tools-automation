...
def fix_habitquest(pbxproj_path):
    ...
    content = re.sub(
        r'\s+MACOSX_DEPLOYMENT_TARGET = \d+\.\d+;\n',
        '',
        content
    )
...
def main():
    ...
    habitquest_pbxproj = projects_dir / "HabitQuest/HabitQuest.xcodeproj/project.pbxproj"
    ...
    momentum_pbxproj = projects_dir / "MomentumFinance/MomentumFinance.xcodeproj/project.pbxproj"
