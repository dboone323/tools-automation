...
performance_comparison() {
  ...
  echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
  printf '%s\n' 'OpenAI GPT-4     | $0.03/1K tok  | Fast     | API Key'
  printf '%s\n' 'Gemini Pro       | $0.0015/1K ch| Fast     | API Key'
  printf '%s\n' 'Ollama Local     | $0.00         | Medium   | Local Install'
  printf '%s\n' 'Hugging Face     | $0.00 (3K/h) | Slow     | Optional Token'
  echo ""
