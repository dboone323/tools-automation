...
AGENT_NAME="agent_supervisor.sh"
...
log_message() {
    ...
    case "$level" in
    "ERROR") echo "[$timestamp] [agent_supervisor] ❌ $message" | tee -a "${LOG_FILE}" ;;
    "WARN") echo "[$timestamp] [agent_supervisor] ⚠️  $message" | tee -a "${LOG_FILE}" ;;
    "INFO") echo "[$timestamp] [agent_supervisor] ℹ️  $message" | tee -a "${LOG_FILE}" ;;
    "DEBUG") echo "[$timestamp] [agent_supervisor] 🔍 $message" | tee -a "${LOG_FILE}" ;;
    *) echo "[$timestamp] [agent_supervisor] 📝 $message" | tee -a "${LOG_FILE}" ;;
    esac
}
